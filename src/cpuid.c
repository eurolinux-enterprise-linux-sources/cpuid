                  ...
                  const code_stash_t*  stash)
{
   ...
   FMQ (    0, 6,  4,14,     sX, "Intel Xeon E3-1500m (Skylake), 14nm"); // no spec update; only 325462 Table 35-1 so far
   ...
   FM  (    0, 6,  5,12,         "Intel Atom (Goldmont), 14nm"); // no spec update; only 325462 Table 35-1 so far
   FM  (    0, 6,  5,13,         "Intel Atom X3-C3000 (SoFIA), 22nm"); // no spec update; only 325462 Table 35-1 so far
   FM  (    0, 6,  5,15,         "Intel Atom (Goldmont), 14nm"); // no spec update; only 325462 Table 35-1 so far
